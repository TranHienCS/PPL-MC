...
class ASTGenSuite(unittest.TestCase):
    ...
    """ Test VerDecl & FuncDecl"""

    def test_VarFunc_Decl_01(self):
        inp="""int iNum;
        string str;
        boolean isTrue;
        void main(){}
    ...
    def test_VarFunc_Decl_18(self):
        inp="""int foo(int arr, int iNum, boolean isTrue){
          isTrue = iNum %2;
        }"""
        out=str(Program([FuncDecl(Id("foo"),[VarDecl(Id("arr"),IntType()),VarDecl(Id("iNum"),IntType()),VarDecl(Id("isTrue"),BoolType())],IntType(),\
            Block([BinaryOp("=",Id("isTrue"),BinaryOp("%",Id("iNum"),IntLiteral(2)))]))]))
    ...
    def test_If_11(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],VoidType(),\
            Block([VarDecl(Id("i"),IntType()),CallExpr(Id("ramdon"),[Id("i")]),If(BinaryOp(">",Id("i"),IntLiteral(10)),\
                Block([Break()]),Block([CallExpr(Id("println"),[Id("i")]),CallExpr(Id("goto"),[CallExpr(Id("ramdon"),[Id("i")])])])),Return(None)]))]))
    ...
    def test_If_12(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],VoidType(),\
            Block([VarDecl(Id("i"),IntType()),CallExpr(Id("ramdon"),[Id("i")]),If(BinaryOp(">",Id("i"),IntLiteral(10)),\
                Block([Break()]),Block([CallExpr(Id("println"),[Id("i")]),CallExpr(Id("goto"),[CallExpr(Id("ramdon"),[Id("i")])])])),Return(CallExpr(Id("pow"),[Id("i"),Id("i")]))]))]))
    ...
    def test_dowhile_if_02(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],VoidType(),\
            Block([If(BinaryOp(">",Id("a"),IntLiteral(5)),\
                    Block([Dowhile([Block([BinaryOp("=",Id("a"),BinaryOp("+",Id("a"),IntLiteral(5))),CallExpr(Id("foo"),[IntLiteral(2)])])],BinaryOp("!=",Id("a"),IntLiteral(100)))]),\
                Block([Dowhile([Block([BinaryOp("=",Id("a"),BinaryOp("*",Id("a"),IntLiteral(2))),CallExpr(Id("compare"),[Id("a"),Id("max")])])],BinaryOp("!=",Id("a"),IntLiteral(144)))]))]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,359)) 

    def test_dowhile_if_03(self):
        inp="""void main () {
          if(a>5){
             int arr[10];
             string str, charStr;
        ...
        out=str(Program([FuncDecl(Id("main"),[],VoidType(),\
            Block([If(BinaryOp(">",Id("a"),IntLiteral(5)),Block([VarDecl(Id("arr"),ArrayType(IntLiteral(10),IntType())),VarDecl(Id("str"),StringType()),VarDecl(Id("charStr"),StringType()),VarDecl(Id("isTrue"),BoolType()),VarDecl(Id("isFact"),BoolType()),VarDecl(Id("isFalse"),BoolType()),VarDecl(Id("fNum"),FloatType()),Dowhile([Block([BinaryOp("=",Id("a"),BinaryOp("+",Id("a"),IntLiteral(5))),CallExpr(Id("foo"),[IntLiteral(2)])])],BinaryOp("!=",Id("a"),IntLiteral(100)))]),\
                Block([VarDecl(Id("arr"),ArrayType(IntLiteral(10),IntType())),VarDecl(Id("str"),StringType()),VarDecl(Id("charStr"),StringType()),VarDecl(Id("isTrue"),BoolType()),VarDecl(Id("isFact"),BoolType()),VarDecl(Id("isFalse"),BoolType()),Dowhile([Block([BinaryOp("=",Id("a"),BinaryOp("*",Id("a"),IntLiteral(2))),CallExpr(Id("compare"),[Id("a"),Id("max")])])],BinaryOp("!=",Id("a"),IntLiteral(144)))]))]))]))
    ...
    def test_For_02(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
            Block([CallExpr(Id("max"),[Id("i")]),\
                CallExpr(Id("min"),[Id("iNum")]),\
                CallExpr(Id("compare"),[CallExpr(Id("max"),[Id("i")]),CallExpr(Id("min"),[Id("iNum")])]),\
                CallExpr(Id("foo"),[CallExpr(Id("max"),[CallExpr(Id("min"),[Id("i")])])])]))]))]))
    ...
    def test_For_03(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
                Block([For(BinaryOp("=",Id("j"),IntLiteral(0)),BinaryOp("<",Id("j"),Id("i")),BinaryOp("=",Id("j"),BinaryOp("+",Id("j"),IntLiteral(1))),\
                    Block([CallExpr(Id("foo"),[Id("i"),Id("j"),CallExpr(Id("max"),[BinaryOp("*",Id("i"),Id("j")),Id("iNum")])])]))]))]))]))
    ...
    def test_For_04(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
                Block([For(BinaryOp("=",Id("j"),IntLiteral(0)),BinaryOp("<",Id("j"),Id("i")),BinaryOp("=",Id("j"),BinaryOp("+",Id("j"),IntLiteral(1))),\
                    Block([For(BinaryOp("=",Id("k"),IntLiteral(0)),BinaryOp("<",Id("k"),Id("j")),BinaryOp("=",Id("k"),BinaryOp("+",Id("k"),IntLiteral(1))),\
                        Block([For(BinaryOp("=",Id("l"),IntLiteral(0)),BinaryOp("<",Id("l"),Id("k")),BinaryOp("=",Id("l"),BinaryOp("+",Id("l"),IntLiteral(2))),\
                            Block([CallExpr(Id("getText"),[Id("i"),Id("j"),Id("k"),Id("l")])]))]))]))]))]))]))
    ...
    def test_dowhile_if_for_01(self):
        inp="""int main(){
          for(i=0;i<iNum;i=i+2){
            if(i%2==0){
              println(i);
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
                    Block([If(BinaryOp("==",BinaryOp("%",Id("i"),IntLiteral(2)),IntLiteral(0)),Block([CallExpr(Id("println"),[Id("i")])]),\
                Block([Dowhile([Block([BinaryOp("=",Id("iNum"),BinaryOp("-",Id("iNum"),Id("i"))),CallExpr(Id("foo"),[BinaryOp("%",Id("iNum"),Id("i"))]),CallExpr(Id("println"),[Id("iNum")])])],BinaryOp(">",Id("iNum"),CallExpr(Id("pow"),[Id("i"),IntLiteral(4)])))]))]))]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,368))

    def test_dowhile_if_for_02(self):
        inp="""int main(){
          for(i=0;i<iNum;i=i+2){
            k = foo(i,pow(i,3));
            if(k>144){
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
                Block([BinaryOp("=",Id("k"),CallExpr(Id("foo"),[Id("i"),CallExpr(Id("pow"),[Id("i"),IntLiteral(3)])])),If(BinaryOp(">",Id("k"),IntLiteral(144)),\
                    Block([Break()]),Block([Continue()])),CallExpr(Id("println"),[Id("k")])]))]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,371))

    def test_dowhile_if_for_03(self):
        inp="""int main(){
          for(i=0;i<iNum;i=i+2){
            k = foo(i,pow(i,3));
            if(k>144){
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([For(BinaryOp("=",Id("i"),IntLiteral(0)),BinaryOp("<",Id("i"),Id("iNum")),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(2))),\
                Block([BinaryOp("=",Id("k"),CallExpr(Id("foo"),[Id("i"),CallExpr(Id("pow"),[Id("i"),IntLiteral(3)])])),If(BinaryOp(">",Id("k"),IntLiteral(144)),\
                    Block([Break()]),Block([Continue()])),If(BinaryOp("==",Id("i"),Id("prime")),\
                        Block([Return(IntLiteral(0))]),None),CallExpr(Id("println"),[Id("k")])]))]))]))
    ...
    def test_Complex_01(self):
        ...
        out=str(Program([FuncDecl(Id("foo"),[VarDecl(Id("arr"),ArrayPointerType(IntType())),VarDecl(Id("iNum"),IntType()),VarDecl(Id("isTrue"),BoolType())],IntType(),\
            Block([BinaryOp("=",Id("isTrue"),BinaryOp("%",Id("iNum"),IntLiteral(2))),BinaryOp("=",ArrayCell(Id("arr"),IntLiteral(0)),BinaryOp("%",Id("iNum"),IntLiteral(6))),BinaryOp("=",Id("iNum"),BinaryOp("+",Id("iNum"),IntLiteral(19))),BinaryOp("=",ArrayCell(Id("arr"),IntLiteral(1)),BinaryOp("+",ArrayCell(Id("arr"),IntLiteral(0)),Id("iNum"))),CallExpr(Id("foo"),[Id("arr"),Id("iNum"),Id("isTrue")]),Return(Id("iNum"))]))]))
    ...
    def test_Complex_02(self):
        ...
        out=str(Program([FuncDecl(Id("foo"),[VarDecl(Id("arr"),ArrayPointerType(IntType())),VarDecl(Id("iNum"),IntType()),VarDecl(Id("isTrue"),BoolType())],IntType(),\
            Block([Return(Id("isTrue")),Return(BinaryOp("=",ArrayCell(Id("arr"),IntLiteral(0)),BinaryOp("%",Id("iNum"),IntLiteral(6)))),Return(BinaryOp("=",Id("iNum"),BinaryOp("+",Id("iNum"),IntLiteral(19)))),Return(BinaryOp("=",ArrayCell(Id("arr"),IntLiteral(1)),BinaryOp("+",ArrayCell(Id("arr"),IntLiteral(0)),Id("iNum")))),Return(CallExpr(Id("foo"),[Id("arr"),Id("iNum"),Id("isTrue")])),Return(Id("iNum"))]))]))
    ...
    def test_Complex_05(self):
        inp="""int foo(int arr[], int iNum, boolean isTrue){
          {{{{int iNum;}}}}
        }"""
        out=str(Program([FuncDecl(Id("foo"),[VarDecl(Id("arr"),ArrayPointerType(IntType())),VarDecl(Id("iNum"),IntType()),VarDecl(Id("isTrue"),BoolType())],IntType(),\
            Block([Block([Block([Block([Block([VarDecl(Id("iNum"),IntType())])])])])]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,380)) 

    def test_Complex_06(self):
        inp="""int foo(int arr[], int iNum, boolean isTrue){
          {{{{iNum = iNum + 10;}}}}
        }"""
        out=str(Program([FuncDecl(Id("foo"),[VarDecl(Id("arr"),ArrayPointerType(IntType())),VarDecl(Id("iNum"),IntType()),VarDecl(Id("isTrue"),BoolType())],IntType(),\
            Block([Block([Block([Block([Block([BinaryOp("=",Id("iNum"),BinaryOp("+",Id("iNum"),IntLiteral(10)))])])])])]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,381))  

    def test_Complex_07(self):
        inp="""int i ;
                  int f ( ) {
                  return 200;
                   }
        ...
        out=str(Program([VarDecl(Id("i"),IntType()),FuncDecl(Id("f"),[],IntType(),\
            Block([Return(IntLiteral(200))])),FuncDecl(Id("main"),[],VoidType(),\
            Block([VarDecl(Id("main"),IntType()),BinaryOp("=",Id("main"),CallExpr(Id("f"),[])),CallExpr(Id("putIntLn"),[Id("i")]),\
                Block([VarDecl(Id("i"),IntType()),VarDecl(Id("main"),IntType()),VarDecl(Id("f"),IntType()),BinaryOp("=",Id("main"),BinaryOp("=",Id("f"),BinaryOp("=",Id("i"),IntLiteral(100)))),CallExpr(Id("putIntLn"),[Id("i")]),CallExpr(Id("putIntLn"),[Id("main")]),CallExpr(Id("putIntLn"),[Id("f")])]),CallExpr(Id("putIntLn"),[Id("main")])]))]))
        self.assertTrue(TestAST.checkASTGen(inp,out,382))   

    def test_Complex_08(self):
        inp="""int main(){
        int a, b, arr[10];
        boolean isTrue, isFact;
        string str;
    ...
    def test_Complex_11(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),\
            Block([VarDecl(Id("a"),IntType()),VarDecl(Id("b"),IntType()),VarDecl(Id("arr"),ArrayType(IntLiteral(10),IntType())),VarDecl(Id("isTrue"),BoolType()),VarDecl(Id("isFact"),BoolType()),VarDecl(Id("str"),StringType()),\
                VarDecl(Id("fNum"),FloatType()),BinaryOp("=",Id("isFact"),UnaryOp("-",Id("isTrue"))),\
                BinaryOp("=",Id("isFact"),UnaryOp("!",Id("isFact"))),BinaryOp("=",Id("isTrue"),UnaryOp("-",UnaryOp("-",Id("isFact")))),\
                BinaryOp("=",Id("isTrue"),BinaryOp("=",Id("isTrue"),BinaryOp("=",UnaryOp("!",UnaryOp("!",Id("isTrue"))),UnaryOp("-",UnaryOp("!",UnaryOp("-",UnaryOp("!",Id("isTrue"))))))))]))]))
    ...
    def test_Complex_24(self):
        ...
        out=str(Program([FuncDecl(Id("main"),[],IntType(),Block([VarDecl(Id("bin"),IntType()),VarDecl(Id("gray"),IntType()),CallExpr(Id("printf"),[StringLiteral("Enter a binary number: ")]),CallExpr(Id("scanf"),[StringLiteral("%d"),Id("bin")]),BinaryOp("=",Id("gray"),CallExpr(Id("bintogray"),[Id("bin")])),CallExpr(Id("printf"),[StringLiteral("The gray code of %d is %d"),Id("bin"),Id("gray")]),Return(IntLiteral(0))])),FuncDecl(Id("bintogray"),[VarDecl(Id("bin"),IntType())],IntType(),\
            Block([VarDecl(Id("a"),IntType()),VarDecl(Id("b"),IntType()),VarDecl(Id("result"),IntType()),VarDecl(Id("i"),IntType()),BinaryOp("=",Id("result"),IntLiteral(0)),BinaryOp("=",Id("i"),IntLiteral(0)),\
                Dowhile([Block([BinaryOp("=",Id("a"),BinaryOp("%",Id("bin"),IntLiteral(10))),BinaryOp("=",Id("bin"),BinaryOp("/",Id("bin"),IntLiteral(10))),BinaryOp("=",Id("b"),BinaryOp("%",Id("bin"),IntLiteral(10))),If(BinaryOp("||",BinaryOp("&&",Id("a"),UnaryOp("!",Id("b"))),BinaryOp("&&",UnaryOp("!",Id("a")),Id("b"))),Block([BinaryOp("=",Id("result"),BinaryOp("+",Id("result"),CallExpr(Id("pow"),[IntLiteral(10),Id("i")])))]),None),BinaryOp("=",Id("i"),BinaryOp("+",Id("i"),IntLiteral(1)))])],BinaryOp("!=",Id("bin"),IntLiteral(0))),Return(Id("result"))]))]))
